...
from src.yt2mp3.api import DownloadRequest, normalize_resolution
    ...
    def test_import_from_repo_root_exposes_version_and_api_symbols(self):
        ...
        result = subprocess.run(
            [
                ...
                "-c",
                "import yt2mp3; "
                "from yt2mp3 import ConfigManager, YouTubeDownloader, CLI, url, DownloadRequest, DownloadResult; "
                "import yt2mp3.config; "
                "print(yt2mp3.__version__); "
                "print(all([ConfigManager, YouTubeDownloader, CLI, url, DownloadRequest, DownloadResult])); "
